...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 11 2016 г., 22:08
...
INSERT INTO `booking` (`id`, `city_id`, `name`, `description`, `type_id`, `price`, `options`, `images`, `status`, `bonus`, `coords_lat`, `coords_lng`, `discount`) VALUES
(1, NULL, 'Stella Artois', '<p>телки, бухич, капитан морган</p>', 1, 100, 'телки, бухич, капитан морган', 0, 0, 10, NULL, NULL, 10),
(2, 1, 'Отель Сибирь', '<p>Комфортабельный отель эконом класса</p>', 3, 250, 'шлюхи шконка блэкджек расчет в баксах', 0, 1, 25, '55.02920280123825', '82.90462374687195', 10),
(3, 1, 'Отель Аврора', '<p>Баня ебальня</p>', 3, 250, 'шлюхи шконка ноу инклудед', 0, 1, 25, '55.0207773372204', '82.98860907554626', 10),
(4, 1, 'Аренда яхты на Обском море', '<p>Аренда яхты на Обском море - охуительно )</p>', 1, 1500, 'нет', 0, 1, 10, '54.829765548556665', '83.05801391601562', 10),
(6, NULL, 'Профессиональный фотограф и гид людоед к вашим услугам', '<p><strong>Профессиональный фотограф и гид людоед к вашим услугам</strong></p>', 7, 22222, '112', 0, 1, 11, NULL, NULL, 10),
(7, NULL, 'Phi-Phi Islands', '<p style="color: #333333; font-family: \'Trebuchet MS\', Arial, Helvetica, sans-serif; font-size: 16px;" align="justify">&nbsp; Острова Пхи-Пхи расположены в 40 км на юго-восток от Пхукета. Пхи-Пхи - это небольшой архипелаг, состоящий из 6 островов:&nbsp;<strong>Phi-Phi Don</strong>&nbsp;(единственный обитаемый),<strong>Phi-Phi Ley</strong>&nbsp;c бухтой Майа (Maya bay), где снимался фильм "Пляж",&nbsp;<strong>Mosquito</strong>&nbsp;(в переводе "комар"),&nbsp;<strong>Bamboo</strong>&nbsp;(в переводе "бамбуковый") и две небольшие скалы&nbsp;<strong>Bida Nok</strong>&nbsp;и&nbsp;<strong>Bida Nai</strong>.</p>\r\n<p style="color: #333333; font-family: \'Trebuchet MS\', Arial, Helvetica, sans-serif; font-size: 16px;" align="justify">&nbsp;&nbsp;&nbsp;Во время однодневной экскурсии вы посетите Phi-Phi Ley, где находятс</p>', 4, 1500, 'russ guide', 0, 1, 0, NULL, NULL, 0);
