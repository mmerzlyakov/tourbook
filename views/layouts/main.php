                ...
                <div class="hidden-xs col-sm-5 col-md-3 group col-lg-push-4 col-md-push-3">
                    <div class="row">
                        <div class="dropdown">
                            ...
                            ?>
                            <a href="#" data-toggle="dropdown" role="button" class="dropdown-toggle white no-border" data-placement="left" title="<?=\Yii::t('app','Language')?> ">
                        ...
                        <div class="dropdown">
                            <a href="#" data-toggle="dropdown" role="button" class="dropdown-toggle white"  data-placement="right" title="<?=\Yii::t('app','Currency')?>"><?=$flagsImages[$index]['currency']?><b class="caret"></b></a>
