...
<div id="private-tour">
    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-md-8">
            ...
            <h1 class="title">Singapure Zoo</h1>
            <div class="text">
                <p> Зоопарк Сингапура (известный также как Зоопарк Мандай, занимает 28 гектаров (69 акров)
                    на берегу водохранилища, покрытого густым лесом в центральном водном заповеднике
                    (англ.)русск.. Зоопарк построен на грант в $9 млн, предоставленный правительством
                    Сингапура и был открыт 27 июня 1973 года. Зоопарк управляется неправительственной
                    организацией Wildlife Reserves Singapore (англ.)русск., которая также управляет Ночным сафари,
                    Парком птиц «Джуронг» и Речным сафари.</p>
                <p>
                    В зоопарке содержатся 315 видов животных, из которых около 16 % находятся под угрозой
                    исчезновения.</p>
                <p>
                    Зоопарк ежегодно посещает около 1,6 миллиона посетителей.С самого начала своей работы
                    Сингапурский зоопарк следовал
                    современной тенденции — представлять животных в естественной среде обитания,
                    с открытыми вольерами, рвами и стеклянными заграждениями между
                    животными и посетителями. В 1977 году известный приматолог Франсин
                    Ниго провела шесть месяцев в клетке с восемнадцатью орангутангами
                    в зоопарке Сингапура для изучения поведения приматов.</p>
                <h3>Шоу</h3>
                <p> Зоопарк Сингапура (известный также как Зоопарк Мандай, занимает 28 гектаров (69 акров)
                    на берегу водохранилища, покрытого густым лесом в центральном водном заповеднике
                    (англ.)русск.. Зоопарк построен на грант в $9 млн, предоставленный правительством
        ...
        <div class="col-xs-12 col-md-4 sidebar ">
            ...
            <div class="price"><b>взрослый - 55$</b></div>
            <div class="price"><b>дестский - 39$</b></div>
            <div class="sh">дети до 5 лет бесплатно</div>
            <div class="button map"><div class="oran">VIEW ON MAP</div></div>
            <!--Бронь-->
            <div class="booking">
